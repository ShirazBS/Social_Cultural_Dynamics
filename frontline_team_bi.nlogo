...
to setup-companies
  ask patches [
    sprout 70 [
      ...
      let global-white-men-proportion 0.3425
      let global-colored-men-proportion 0.1825
      let global-white-women-proportion 0.2925
      let global-colored-women-proportion 0.1825
   ...
   let white-men-proportion 0
      ...
      let latino-men-proportion (colored-men-proportion * 0.497)
      let asian-men-proportion (colored-men-proportion * 0.082)
      let black-men-proportion (colored-men-proportion * 0.354)
      let other-men-proportion (colored-men-proportion * 0.067)

      let latino-women-proportion (colored-women-proportion * 0.497)
      let asian-women-proportion (colored-women-proportion * 0.082)
      let black-women-proportion (colored-women-proportion * 0.354)
      let other-women-proportion (colored-women-proportion * 0.067)
...
to initialize-gender-ethnicity-vectors
  ...
  set white-male-vector   [1 0 0 0 0]  ; Male, White
  set white-female-vector [1 0 0 0 0]  ; Female, White

  set black-male-vector   [0 0 1 0 0]  ; Male, Black
  set black-female-vector [0 0 1 0 0]  ; Female, Black

  set latino-male-vector   [0 1 0 0 0] ; Male, Latino
  set latino-female-vector [0 1 0 0 0] ; Female, Latino

  set asian-male-vector   [0 0 0 1 0]  ; Male, Asian
  set asian-female-vector [0 0 0 1 0]  ; Female, Asian

  set other-male-vector   [0 0 0 0 1]  ; Male, Other
  set other-female-vector [0 0 0 0 1]  ; Female, Other
end
